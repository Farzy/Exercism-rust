...
#[test]
fn very_large_matrix() {
    let input = create_saddle((0, 1000), (0, 1000));
    assert_eq!(
        vec![(491, 500), (492, 500), (493, 500), (494, 500), (495, 500), (496, 500),
             (497, 500), (498, 500), (499, 500), (500, 500), (501, 500), (502, 500),
             (503, 500), (504, 500), (505, 500), (506, 500), (507, 500), (508, 500),
             (509, 500)],
        find_sorted_saddle_points(&input)
    );
}
